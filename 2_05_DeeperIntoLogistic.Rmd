...
You should see a smooth approach to $K$ in Figure 1, a straight decreasing line in Figure 2 that crosses zero at $K$, and a single peaked curve in Figure 3 with a maximum near $N = K/2$.
