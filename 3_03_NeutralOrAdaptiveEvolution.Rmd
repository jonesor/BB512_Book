...
Traits like resistance to infectious disease are likely to face strong selection in environments where the disease is common, while traits with little effect on survival or reproduction (e.g., subtle iris patterns) are more likely to drift.
...
- Selection strength depends on environment and context, not just the trait itself.
- Many traits can evolve neutrally if they do not strongly affect fitness.
