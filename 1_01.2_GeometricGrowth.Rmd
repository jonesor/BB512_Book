...
3.	Make another plot of the same data, but this time use a natural logarithmic axis for the population size (hint: the base for natural log is 2.71828). An alternative is to make another column of data calculating the natural logarithm of the population size. If you don’t know how to do this, use Excel’s help to find how to calculate logarithms, or alter the axis (or ask for help!).
