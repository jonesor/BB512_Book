...
1. Calculate survivorship at age 1: $l_1 = 352/500$.
2. Calculate survival probability from age 0 to 1: $g_0 = 352/500$.
3. Calculate death probability in that interval: $q_0 = 1 - g_0$.
