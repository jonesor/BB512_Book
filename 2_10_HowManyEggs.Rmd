...
1. Compute expected surviving chicks: clutch size $\times$ survival probability.
2. Repeat this calculation for all clutch sizes.
3. Compare expected survivors across clutch sizes.

### Output and interpretation

For 2 eggs, expected survivors are $2 \times 0.85 = 1.7$. Doing this for all clutch sizes typically reveals a peak at an intermediate number of eggs.
