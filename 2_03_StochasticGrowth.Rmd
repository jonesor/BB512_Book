...
- Stochasticity introduces variability in trajectories even when average growth is positive.
- Small populations are more vulnerable to random declines and extinction.
- The variance of $r_m$ can be as important as its mean for long-term persistence.
