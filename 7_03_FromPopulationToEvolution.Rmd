...
Thus, the population is growing at `r format(100*(eigs(A1,what = "lambda")-1), digits = 4)`% per year.
...
The small increase in juvenile survival has resulted in a small increase in population growth rate, from `r format(100*(eigs(A1)$lambda-1), digits = 4)`% to `r format(100*(eigs(A2)$lambda-1), digits = 4)`% per year.
