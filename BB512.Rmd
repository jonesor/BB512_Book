...
# The BB512_Schedule.xlsx file is where I plan the course "by day"
...
curl::curl_download("https://mitsdu.sdu.dk/skema/icalendar/activities/N100007101/e23/e23", 
                    destfile = "bb512.ics")
```
...
courseCal <- ical_parse_df("bb512.ics") %>%
  filter(!is.na(uid)) %>%
  arrange(start) %>%
