...
With benefits $B = 4$ and costs $C = 3$, the Hawk–Hawk payoff is $(B-C)/2 = 0.5$, Hawk–Dove yields 4 for Hawk and 0 for Dove, and Dove–Dove yields 2 each.
...
0. On a piece of paper, or in Excel (you could use this file [here](https://www.dropbox.com/s/48lypfd6o0hi46e/Table_2_Group_behaviour.xlsx?dl=1)), use a form to collect your results. It should have enough rows for 15 rounds of the game and look like this (where I include an example in the first row):
...
2. Take out the cards labelled hawk and dove and place them face down on the table or conceal them in your hands.
...
4. In each round, note the cards played and the benefit received by each player. Also do it here on [this Google Form](https://forms.gle/3fjBGF7xVAYRQ5hXA).
...
This exercises is taken from https://www.jove.com/science-education/10611/group-behaviour
