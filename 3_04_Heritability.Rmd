...
```{r heritability-setup, echo = FALSE}
...
3. Interpret the slope as narrow-sense heritability ($h^2$).

### Output and interpretation

$h^2 = 0.4$, meaning about 40% of trait variance is attributable to additive genetic effects in that population and environment.
...
```{r heritability_starter_code, eval = FALSE, echo = TRUE}
