...
With an initial allele frequency of 0.5 and a population size of 20, repeated sampling will often shift frequencies noticeably in just a few generations. In contrast, a population of 1000 will show much smaller random fluctuations.
...
```{r simulationplot, fig.cap = "Simulation of allele frequency through time", echo = TRUE}
...
```{r bottlenecksimulation, eval = FALSE, echo = TRUE}
if (i %in% 30:50) {
  pop_size <- 10
} else {
  pop_size <- 1000
...
```{r bottlenecksimulationplot, fig.cap = "Simulation of a genetic bottleneck", echo = TRUE}
# Set number of generations
n_gen <- 100
...
- Bottlenecks and founder effects can rapidly reshape allele frequencies.
