...
We'll focus on the discrete form:  $N_{t+1}=\lambda N_t$  ^[Equation 1.15 in Gotelli]

In many cases it is unlikely that the finite rate of increase ($\lambda$) will be constant through time. Population growth rates are likely to vary through time because of environmental factors (weather, food supply etc.). This is called *environmental stochasticity*.
